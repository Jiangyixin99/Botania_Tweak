...
public class KubeJSBotaniaForge {
    ...
    public static final RegistryObject<RecipeSerializer<AgglomerationRecipe>> TERRA_PLATE_SERIALIZER = SERIALIZERS
            .register("terra_plate", () -> AgglomerationRecipeSerializer.INSTANCE);
